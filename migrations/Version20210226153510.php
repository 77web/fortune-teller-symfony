 ...
 */
final class Version20210226153510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fortunes CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE target_date target_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', CHANGE fortune_text fortune_text LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fortunes CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE target_date target_date DATE NOT NULL, CHANGE fortune_text fortune_text VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
}
